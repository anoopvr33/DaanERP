import "./style.css";
import { Delete_Daily_Category } from "../../api/accountsServices";

const ListDailyCategory = ({ categories }) => {
  ...
  const Delete_Category = async (value) => {
    await Delete_Daily_Category({ id: value });
  };

  return (
    <div style={{ marginTop: "20px" }} className="department-container">
...
export default ListDailyCategory;
